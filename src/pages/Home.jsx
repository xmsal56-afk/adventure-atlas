    ...
    <div>
      <div className="text-center mb-8">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          <button onClick={pickRandom} className="inline-flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-xl font-semibold hover:bg-primary-dark transition-all shadow-md hover:shadow-lg cursor-pointer border-0">🎲 Surprise Me</button>
        </div>
      </div>
        ...
        <div className="flex items-center gap-3">
          {compareMode && compareIds.length >= 2 && (
            <button onClick={() => document.getElementById("compare-modal")?.classList.remove("hidden")}
              className="text-sm font-semibold bg-pink-500 text-white px-4 py-2 rounded-lg hover:bg-pink-600 transition-colors cursor-pointer border-0">⚖️ Compare {compareIds.length}</button>
          )}
          <button onClick={() => setCompareMode(!compareMode)}
            className="text-sm font-semibold bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 px-4 py-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors cursor-pointer border-0">
